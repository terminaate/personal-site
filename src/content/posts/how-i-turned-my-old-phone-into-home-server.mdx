---
title: How i turned my old phone into home server
...
Once I did that, I understood that this wasn’t the best idea.
...
That was really easy, and with that I opened sftp port, termux have a really good [documentation](https://wiki.termux.com/wiki/Remote_Access).
...
never built linux kernel in my life and especially kernel for my device.
...
You can find out the completed kernel for my device [here](https://github.com/terminaate/android_kernel_samsung_exynos9610_mint_docker)

After I finally just run docker's `hello-world` on my device, I was glad. There were some other minor problems, like `docker-compose` wasn't working properly, but I fixed them quickly.
...
![beszel](/src/assets/images/beszel.png "beszel")

![homarr](/src/assets/images/homarr.png "homarr")

![portainer](/src/assets/images/portainer.png "portainer")
